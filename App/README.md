...
To run this app locally, simply clone this repository, and place the folder containing the downloaded image files (rename it "WCMA Public Thumbs") in the folder called "App".